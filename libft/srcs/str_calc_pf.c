...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/30 11:50:33 by hehlinge          #+#    #+#             */
/*   Updated: 2019/09/30 12:09:52 by hehlinge         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_stradd(char *sht, char *lng)
{
	...
	while (--len > -1 && --pos > -1)
	{
		ret[pos] = (lng[pos] + sht[len] + ret[pos + 1] - 48 * 3) / 10 + 48;
		ret[pos + 1] = (lng[pos] + sht[len] + ret[pos + 1] - 48 * 3) % 10 + 48;
	}
	while (pos-- > 0)
	{
		ret[pos] = (lng[pos] + ret[pos + 1] - 48 * 2) / 10 + 48;
		ret[pos + 1] = (lng[pos] + ret[pos + 1] - 48 * 2) % 10 + 48;
	}
	return (ret);
}
