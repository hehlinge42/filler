...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/10/01 18:42:52 by hehlinge          #+#    #+#             */
/*   Updated: 2019/10/08 14:45:37 by hehlinge         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int							set_add_neg_8k(t_flt *flt);
int							set_add_neg_4k(t_flt *flt);
int							set_add_pos_4k(t_flt *flt);
int							set_add_pos_8k(t_flt *flt);
int							set_add_pos_16k(t_flt *flt);
int							ft_calc_flt(t_flt *flt);
int							ft_pad_flt(t_flt *flt, t_buf *buf, t_arg *arg);
int							ft_end_flt(t_flt *flt);
...
void						ft_round(t_flt *flt, t_arg *arg, long long int len_r
	, char *ret);
